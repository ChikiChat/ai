...
export class OpenRouter extends Provider {
    ...
    models = [
        {
            id: `${this.id}/qwen/qvq-72b-preview`,
        ...
        },
        {
            ...
            name: 'Euryale v2.3 (70B) LLaMA 3.3',
            description: '',
            ...
            price: {input: 0.0000015000, output: 0.0000015000},
        },
        {
            id: `${this.id}/inflatebot/mn-mag-mell-r1`,
        ...
        },
        {
            ...
            price: {input: 0.0000002700, output: 0.0000002700},
        },
        {
        ...
        {
            id: `${this.id}/qwen/qwen-2-vl-72b-instruct`,
        ...
        {
            id: `${this.id}/qwen/qwen-2-vl-7b-instruct`,
            name: 'Qwen 2 (7B) Vl Instruct',
            description: '',
            architecture: 'Qwen2VLForConditionalGeneration',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            name: 'Euryale V2.21 (70B) LLaMA 3.1',
            description: '',
            architecture: 'LlamaForCausalLM',
            capabilities: {
                embedding: false,
            ...
            price: {input: 0.0000003500, output: 0.0000004000},
        },
        {
        ...
        {
            id: `${this.id}/meta-llama/llama-3.1-405b-instruct:free`,
        ...
        {
            id: `${this.id}/meta-llama/llama-3.1-70b-instruct:free`,
        ...
        },
        {
            ...
            name: 'Dolphin 2.9.2 (8X22B) Mixtral',
            description: '',
            architecture: 'MixtralForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            price: {input: 0.0000003400, output: 0.0000003900},
        },
        {
            id: `${this.id}/nousresearch/hermes-2-pro-llama-3-8b`,
            name: 'Hermes 2 Pro (8B) LLaMA 3',
            description: '',
            architecture: 'LlamaForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            price: {input: 0.0000010800, output: 0.0000010800},
        },
        {
            id: `${this.id}/sophosympatheia/midnight-rose-70b`,
            name: 'Midnight Rose v2.0.3 (70B) ',
            description: '',
            architecture: 'LlamaForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            name: 'Nous Hermes 2 (8X7B) Mixtral',
            description: '',
            architecture: 'MixtralForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            name: 'Airoboros v3.1.2 (70B) LLaMA 2',
            description: '',
            architecture: 'LlamaForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            name: 'MythoMax (13B) LLaMA 2 (free)',
            description: '',
            architecture: 'LlamaForCausalLM',
            capabilities: {
                embedding: false,
        ...
        },
        {
            ...
            price: {input: 0.0000001980, output: 0.0000001980},
        },
    ];
    default = {
