    ...
    models = [
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 152064, embedding: 8192, input: 16384, output: 4096},
                text: {input: true, output: true},
                image: {input: true, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 8192, input: 4096, output: 4096},
                text: {input: true, output: true},
                image: {input: true, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 4096, input: 4096, output: 4096},
                text: {input: true, output: true},
                image: {input: true, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
