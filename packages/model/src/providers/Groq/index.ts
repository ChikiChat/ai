    ...
    models = [
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 8192, input: 131072, output: 131072},
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 8192, input: 131072, output: 32768},
                text: {input: true, output: true},
                image: {input: false, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 4096, input: 131072, output: 131072},
                text: {input: true, output: true},
                image: {input: false, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
