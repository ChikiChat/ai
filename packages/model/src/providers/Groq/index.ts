...
export class Groq extends Provider {
    ...
    models = [
        {
            id: `${this.id}/deepseek-r1-distill-qwen-32b`,
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 152064, embedding: 5120, input: 131072, output: 131072},
                text: {input: true, output: true},
                image: {input: false, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
            },
            price: {input: 0.0000006900, output: 0.0000006900},
        },
        {
            ...
            price: {input: 0.0000007500, output: 0.0000009900},
        },
        {
            ...
            price: {input: 0.0000002900, output: 0.0000003900},
        },
        {
            id: `${this.id}/qwen-2.5-32b`,
            name: 'Qwen 2.5 (32B)',
            description: '',
            architecture: 'Qwen2ForCausalLM',
            capabilities: {
        ...
        {
            id: `${this.id}/meta-llama/llama-4-maverick-17b-128e-instruct`,
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 202048, embedding: 5120, input: 131072, output: 8192},
                text: {input: true, output: true},
                image: {input: false, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
        ...
        },
        {
            ...
            price: {input: 0.0000001100, output: 0.0000003400},
        },
        {
        ...
        },
        {
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 128256, embedding: 4096, input: 32768, output: 8192},
                text: {input: true, output: true},
                image: {input: false, output: false},
                audio: {input: false, output: false},
                video: {input: false, output: false},
        ...
        {
            id: `${this.id}/mistral-saba-24b`,
            name: 'Mistral (24B) Saba',
            description: '',
            architecture: '',
            capabilities: {
                embedding: false,
        ...
        {
            id: `${this.id}/whisper-large-v3-turbo`,
            ...
            capabilities: {
                ...
                rerank: false,
                features: [],
                size: {vocab: 51866, embedding: 0, input: 0, output: 448},
                text: {input: false, output: true},
                image: {input: false, output: false},
                audio: {input: true, output: false},
                video: {input: false, output: false},
            },
            price: {input: 0.0000000000, output: 0.0400000000},
        },
        {
            id: `${this.id}/whisper-large-v3`,
            ...
            price: {input: 0.0000000000, output: 0.1110000000},
        },
        {
            id: `${this.id}/distil-whisper-large-v3-en`,
            ...
            price: {input: 0.0000000000, output: 0.0200000000},
        },
    ];
    default = {
